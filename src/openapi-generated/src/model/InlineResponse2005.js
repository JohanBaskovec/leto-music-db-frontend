...
import ArtistBandMembership from './ArtistBandMembership';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [ArtistBandMembership]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/ArtistBandMembership>} results
 */

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.AuthToken();
  });
  ...
  describe('AuthToken', function() {
    it('should create an instance of AuthToken', function() {
      ...
      //var instane = new OpenapiJsClient.AuthToken();
      //expect(instance).to.be.a(OpenapiJsClient.AuthToken);
    });

    it('should have the property username (base name: "username")', function() {
      // uncomment below and update the code to test the property username
      //var instance = new OpenapiJsClient.AuthToken();

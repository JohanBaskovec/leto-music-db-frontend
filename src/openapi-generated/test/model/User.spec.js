...
(function(root, factory) {
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instane = new OpenapiJsClient.User();
    ...
    it('should have the property albumReviews (base name: "album_reviews")', function() {
      // uncomment below and update the code to test the property albumReviews
      //var instance = new OpenapiJsClient.User();
      //expect(instance).to.be();
    });
